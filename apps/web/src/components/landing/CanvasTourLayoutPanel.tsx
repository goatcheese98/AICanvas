			...
			<div ref={ref} className="canvas-tour-layout-panel">
				<div className="canvas-tour-layout-panel-header">
					...
					<p className="canvas-tour-layout-panel-copy">
						Scene-aware registry for presentation framing, guide stops, and future overlay
						authoring.
					</p>
				</div>
							...
							<div className="canvas-tour-layout-placement-header">
								...
								<div className="canvas-tour-layout-preset-grid">
									<button
										...
										onClick={() => applyOverlayPreset('top-left')}
									>
										Top left
									</button>
									<button
										type="button"
										className="canvas-tour-reset"
										onClick={() => applyOverlayPreset('top-center')}
									>
										Top center
									</button>
									<button
										type="button"
										className="canvas-tour-reset"
										onClick={() => applyOverlayPreset('top-right')}
									>
										Top right
									</button>
									<button
										type="button"
										className="canvas-tour-reset"
										onClick={() => applyOverlayPreset('bottom-left')}
									>
										Bottom left
									</button>
								</div>
							...
							<div className="canvas-tour-layout-overlay-grid">
								<label className="canvas-tour-layout-field">
									...
									<input
										...
										onChange={(event) =>
											updateOverlayPlacement('leftRem', Number(event.target.value))
										}
									/>
									<input
										type="number"
								...
								<label className="canvas-tour-layout-field">
									...
									<input
										...
										onChange={(event) =>
											updateOverlayPlacement('topRem', Number(event.target.value))
										}
									/>
									<input
										type="number"
								...
								<label className="canvas-tour-layout-field">
									...
									<input
										...
										onChange={(event) =>
											updateOverlayPlacement('widthRem', Number(event.target.value))
										}
									/>
									<input
										type="number"
