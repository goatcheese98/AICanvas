		...
		<>
			...
			<div className="landing-sketch-layer" aria-hidden="true">
				...
				<div className="landing-sketch-arrow landing-sketch-arrow-1">
					<svg viewBox="0 0 140 60" preserveAspectRatio="none" aria-hidden="true" focusable="false">
				...
				<div className="landing-sketch-arrow landing-sketch-arrow-2">
					<svg viewBox="0 0 100 80" preserveAspectRatio="none" aria-hidden="true" focusable="false">
						<path d="M10 60 Q30 30, 60 40 T90 15" />
						<path d="M82 8 L90 15 L80 22" />
					</svg>
				</div>
				<div className="landing-sketch-arrow landing-sketch-arrow-3">
					<svg viewBox="0 0 120 50" preserveAspectRatio="none" aria-hidden="true" focusable="false">
				...
				<div className="landing-sketch-wiggle landing-sketch-wiggle-2">
					<svg viewBox="0 0 250 50" preserveAspectRatio="none" aria-hidden="true" focusable="false">
				...
				<div className="landing-sketch-wiggle landing-sketch-wiggle-3">
					<svg viewBox="0 0 280 45" preserveAspectRatio="none" aria-hidden="true" focusable="false">
